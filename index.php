...
<html lang="en">
  <head>
    ...
    <meta name="theme-color" content="#0288d1"><!-- update me--><!-- also in the manifest -->
    <meta name="msapplication-TileColor" content="#0288d1"><!-- update me-->
    <meta name="msapplication-TileImage" content="<?php bloginfo('template_url'); ?>/images/icons/msapplication-tile.png">
    ...
    <link rel="icon" type="image/png" href="<?php bloginfo('template_url'); ?>/images/icons/favicon-32x32.png" sizes="32x32">
    <link rel="icon" type="image/png" href="<?php bloginfo('template_url'); ?>/images/icons/favicon-16x16.png" sizes="16x16">
    ...
    <nav>
      ...
      <section id="brand">
        <a class="internal" href="/">
          <img alt="logo" src="<?php bloginfo('template_url'); ?>/images/logo.svg">
        </a>
      </section>
      <ul>
        <li id="home-button">
